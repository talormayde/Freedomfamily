...
export default function HomePage() {
  ...
  // On load, detect existing session. Also react to auth changes.
  useEffect(() => {
    const run = async () => {
      ...
      {view === 'mudroom' && (
        <Page>
          ...
          <Card className="mt-4">
            ...
            <div className="mt-4 grid gap-4">
              {[
                ...
                <div
                  key={i}
                  className="border-t first:border-t-0 border-dashed border-sky-300/70 pt-4 first:pt-0"
                >
                  {a}
                </div>
              ))}
          ...
          <div className="mt-6 grid grid-cols-2 gap-4">
            <button className="aspect-square w-full rounded-[28px] bg-gradient-to-b from-lime-200 to-lime-300 text-zinc-800 font-semibold">
              Study
            </button>
