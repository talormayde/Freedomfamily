  ...
  return (
    <div className="px-4 md:px-6 lg:px-8 max-w-[1200px] mx-auto w-full">
      {!authed && (
        ...
        >
          {/* decorative blur layer — cannot capture clicks */}
          <div className="absolute inset-0 backdrop-blur-md pointer-events-none" aria-hidden="true" />

          {/* real content layer — explicitly clickable and above */}
      ...
      {/* Rooms grid — only after auth (prevents seeing them before login) */}
      {authed && (
